    ...
    <div className={styles.container}>
      ...
      <div className={styles.leftPanel}>
        ...
        <h1 className={styles.leftPanelTitle}>
          Selamat Datang di<span className="hidden sm:inline"><br /></span>{' '}
          <span className="sm:hidden"> </span>
          Manajemen Idle Equipment<span className="hidden sm:inline"><br /></span>{' '}
          <span className="sm:hidden"> </span>
      ...
      <div className={styles.rightPanel}>
        <div className={styles.formContainer}>
          ...
          <form onSubmit={handleLogin}>
            ...
            <button type="submit" className={styles.submitButton} disabled={nik.length < 5 || isLoading}>
