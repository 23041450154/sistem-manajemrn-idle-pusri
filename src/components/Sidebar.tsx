  ...
  return (
    <aside className="w-64 bg-[#0A356A] text-white flex flex-col h-screen shrink-0 sticky top-0 overflow-y-auto">
      ...
      <div className="p-4 mt-auto">
        <button className="w-full flex items-center justify-center gap-2 bg-[#0556B3] hover:bg-blue-600 text-white py-2.5 rounded-lg text-sm font-medium transition-colors shadow-md">
