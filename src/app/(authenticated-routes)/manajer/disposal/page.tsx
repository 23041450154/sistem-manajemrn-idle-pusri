...
import { 
  ...
  Trash2, AlertTriangle, Loader2, Check, DollarSign, Calendar, Tag, Building2
} from "lucide-react";
  ...
  const handleConfirmApprove = async () => {
    ...
    try {
      ...
      if (res.success) {
        showToast(
          "success",
          res.message || "Pengajuan disposal berhasil disetujui, status aset berubah menjadi DISPOSED."
        );
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Persetujuan Disposal Aset</h1>
          </div>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-4 mb-6 shadow-sm">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-100 pb-4 mb-4">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-[12px] font-semibold text-gray-600 hover:text-[#0A356A] bg-gray-50 border border-gray-200 rounded-lg hover:bg-gray-100 transition-colors w-fit"
          >
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl p-6 flex flex-col items-center text-center animate-in zoom-in-95 duration-200 border border-gray-100">
            ...
            <p className="text-[13px] text-gray-600 mb-6 leading-relaxed">
              Apakah Anda yakin ingin menyetujui penghapusan aset ini? Status aset di inventaris akan diubah menjadi <strong className="text-emerald-700 font-bold">DISPOSED</strong>.
            </p>
