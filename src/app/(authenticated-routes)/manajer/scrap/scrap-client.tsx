...
export default function ManajerScrapClient({
  ...
  const handleConfirmApprove = async () => {
    ...
    try {
      ...
      if (res.success) {
        showToast("success", "Scrap sukses disetujui.");
        ...
        setModalError(
          res.message ||
            "Terjadi kendala saat memproses pengajuan. Silakan coba kembali beberapa saat lagi.",
        );
      }
    } catch (err: unknown) {
  ...
  const handleConfirmReject = async () => {
    ...
    try {
      ...
      if (res.success) {
        showToast(
          "reject",
          `Pengajuan ${selectedDisposal.disposal_number} untuk ${selectedDisposal.equipment_code} berhasil ditolak.`,
        );
              ...
              {filteredDisposals.length === 0 ? (
                <tr>
                  ...
                  >
                    ...
                    <p className="text-sm font-semibold text-gray-600">
                      Tidak ada permintaan scrap dalam antrean
                    </p>
                ...
                paginatedDisposals.map((item, index) => (
                  ...
                  >
                    ...
                    <td
                      className="px-3 py-3 text-[13px] font-semibold text-gray-800 text-left"
        ...
        {filteredDisposals.length > 0 && (
          <div className="px-5 py-3 border-t border-gray-200 bg-white flex justify-between items-center">
            <span className="text-[11px] font-medium text-gray-500">
              ...
              dari {filteredDisposals.length} data ({ITEMS_PER_PAGE}{" "}
              baris/halaman)
            </span>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-bold text-gray-900">
                    Detail Peninjauan Permintaan Scrap Aset
                  </h2>
            ...
            <div className="flex-1 overflow-y-auto px-6 py-5 bg-gray-50/50 space-y-6">
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start gap-3 text-amber-900">
                  ...
                  <div>
                    <p className="text-[13px] font-bold">
                      Usulan Permintaan Scrap Aset
                    </p>
                    <p className="text-[12px] text-amber-800 mt-0.5 leading-relaxed">
                      Aset ini telah dinyatakan{" "}
                      <strong>&quot;Rusak Berat&quot;</strong> berdasarkan hasil
                      inspeksi teknik dan telah diajukan oleh Rendal
                      Pemeliharaan untuk proses scrap. Persetujuan Manajer
                      Rendal diperlukan sebelum usulan dapat diproses lebih
                      lanjut.
                    </p>
                  </div>
                </div>
              ...
              {selectedDisposal.status === "DISPOSED" && (
                <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 flex items-start gap-3 text-emerald-900">
                  ...
                  <div>
                    <p className="text-[13px] font-bold">
                      Pengajuan Scrap Disetujui
                    </p>
                    <p className="text-[12px] text-emerald-800 mt-0.5 leading-relaxed">
                      Pengajuan scrap ini telah disetujui oleh Manajer Rendal.
                      Status aset di inventaris telah diperbarui menjadi{" "}
                      <strong>DISPOSAL_VERIFIED</strong> (Scrap).
                    </p>
                  </div>
                </div>
              )}
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
                ...
                <div>
                  <p className="text-[12px] font-bold text-gray-700 mb-1.5">
                    Alasan/Justifikasi Usulan Scrap:
                  </p>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
                <div className="flex items-center gap-2 border-b border-gray-100 pb-3 mb-4">
                  ...
                  <h3 className="text-[14px] font-bold text-gray-900">
                    Dasar Rekomendasi & Riwayat Proses
                  </h3>
                </div>
                <div className="overflow-x-auto">
          ...
          <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl p-6 flex flex-col items-center text-center animate-in zoom-in-95 duration-200 border border-gray-100">
            ...
            <div className="text-[13px] text-gray-600 mb-6 leading-relaxed text-left w-full bg-gray-50 p-4 rounded-xl space-y-3 border border-gray-100">
              ...
              <div>
                ...
                <p className="font-bold text-[#0A356A]">
                  {selectedDisposal.disposal_number}
                </p>
              </div>
              ...
              <p className="text-[11px] text-gray-400 italic pt-1">
                Setelah disetujui, pengajuan akan diteruskan ke proses
                berikutnya.
              </p>
            </div>
