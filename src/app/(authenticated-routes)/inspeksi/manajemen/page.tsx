...
import { Search, Filter, Download, Printer, Eye, Plus } from "lucide-react";
...
export default function InspeksiDashboard() {
  ...
  /* KPI diturunkan dari data nyata; angka hardcode = metrik palsu (blocking). */
  ...
  return (
    <div className="max-w-[1400px] mx-auto p-4 flex flex-col h-[calc(100vh-72px)] overflow-hidden">
      ...
      <div className="flex flex-col gap-4 flex-1 min-h-0 overflow-hidden">
        {/* KPI Cards: pola border-l-2 DESIGN.md */}
                      ...
                      <td className="px-4 py-2 whitespace-nowrap text-right">
                        {row.status !== "Selesai" ? (
                          <Link
                            ...
                            className="inline-block bg-white text-[#0A356A] hover:bg-[#0556B3] hover:text-white border border-[#E6E8EA] px-2.5 py-1 rounded text-[10px] font-semibold transition-colors duration-150"
                          >
                            Mulai
                          </Link>
                        ) : (
