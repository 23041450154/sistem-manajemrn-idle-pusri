...
import { validateEquipment, uploadAttachment } from "@/action/api";
...
/** Client Component: form revisi validasi — data & master kondisi di-fetch Server Component. */
export default function RevisiValidasiClient({
	assets,
	conditions,
}: {
	assets: Asset[];
	...
	const handleSave = async () => {
		...
		try {
			...
			if (res.success) {
				...
				// (aset terproses otomatis keluar dari daftar revisi).
				router.refresh();
			} else {
				setNotification({
					type: "error",
