...
export default async function RegisterEquipmentPage({
	...
	return (
		<RegisterEquipmentClient
			editId={editId ?? null}
			objectTypes={objs as MasterOption[]}
			plants={plantsList as MasterOption[]}
			storageLocations={storageLocList as MasterOption[]}
			funcLocs={funcLocList as MasterOption[]}
