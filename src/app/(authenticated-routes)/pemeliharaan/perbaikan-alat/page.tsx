...
export default function PerbaikanAlatPage() {
	...
	const filteredEquipments = useMemo(() => {
		...
		return result;
	}, [equipments, searchQuery, filterPlant, filterTipeObjek, filterKondisi]);
				...
				<div className="mb-4 flex items-center justify-between bg-blue-50 border border-blue-100 rounded-lg px-4 py-2.5 animate-in fade-in slide-in-from-top-2">
					<div className="flex items-center gap-3">
						...
						<span className="text-[13px] text-blue-800 font-medium">
							Terdapat <strong className="font-bold">{filteredEquipments.length} aset</strong> yang sedang dalam proses perbaikan.
						</span>
					</div>
				</div>
			)}
					...
					<table className="w-full text-left border-collapse">
						<thead className="bg-gray-50/95 backdrop-blur-sm">
							<tr className="border-b border-gray-300">
								...
								<th className="px-3 py-3 text-[14px] font-bold text-gray-600 uppercase tracking-wider text-center whitespace-nowrap">Tgl Diperbarui</th>
								<th className="px-3 py-3 text-[14px] font-bold text-gray-600 uppercase tracking-wider text-center whitespace-nowrap">Aksi</th>
							</tr>
						</thead>
								...
								<tr>
									<td colSpan={9} className="px-5 py-12 text-center text-gray-500">
										<div className="flex flex-col items-center">
											...
											<p className="text-[11px] text-gray-500 mt-1">Tidak ada peralatan dalam proses perbaikan.</p>
										</div>
									</td>
								</tr>
							) : (
