  ...
  const fetchData = async () => {
    try {
        ...
        (item: any) => {
          ...
          return {
            ...
            estimated_reuse_value:
              Number(item.estimated_reuse_value) || 250000000,
            specifications: String(
              specText ||
      ...
      const reqList: ReuseRequestItem[] = (rawRequests || []).map((r: any) => {
        ...
        else if (typeof r.targetPlant === "string")
          targetPlantStr = r.targetPlant;
    ...
    try {
      ...
      if (res.success) {
        ...
        setReuseRequests((prev) => [
          newReq,
          ...prev.filter((r) => r.request_number !== newReq.request_number),
        ]);
