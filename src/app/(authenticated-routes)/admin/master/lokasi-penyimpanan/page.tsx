...
import { Plus, Trash2, CheckCircle2, XCircle, Loader2, Database, MapPin, Pencil, Eye, Search } from "lucide-react";
...
export default function LokasiPenyimpananPage() {
  ...
  const filteredData = searchQuery.trim()
    ? data.filter(item =>
        ...
        (item.plant && item.plant.toLowerCase().includes(searchQuery.toLowerCase())) ||
