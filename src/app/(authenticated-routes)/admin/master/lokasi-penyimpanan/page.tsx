            ...
            <table className="w-full text-left border-collapse table-fixed">
              <thead className="bg-slate-50 border-b border-slate-200">
                <tr>
                  ...
                  <th className="px-3 py-2 text-xs font-semibold text-slate-500 uppercase tracking-wider w-[140px]">Pabrik (Plant)</th>
                  <th className="px-3 py-2 text-xs font-semibold text-slate-500 uppercase tracking-wider">Deskripsi Keterangan</th>
              ...
              <tbody className="bg-white divide-y divide-slate-100">
                {paginatedData.map((item) => (
                  <tr key={item.id} className="hover:bg-gray-50/50 transition-colors h-[48px]">
                    ...
                    <td className="px-3 py-2 text-sm text-slate-500 font-medium truncate">
