# Graph Report - sistem-manajemrn-idle-pusri  (2026-08-31)
...
- 742 nodes · 1482 edges · 56 communities (44 shown, 12 thin omitted)
...
3. `getCurrentUserAction()` - 25 edges
4. `normalizeRole()` - 25 edges
5. `buttonVariants` - 23 edges
6. `homePathForRole()` - 23 edges
7. `revalidateApp()` - 22 edges
...
### Community 0 - "RendalDashboard.tsx"

Cohesion: 0.16
Nodes (12): ChartSection(), CostAvoidanceSection(), Equipment, RendalDashboard(), Activity, RecentActivities(), StatCard(), StatCardProps (+4 more)
...
### Community 12 - "perbaikan-alat-client.tsx"

Cohesion: 0.22
Nodes (12): completeEquipmentRepair(), findLatestInspectionId(), PerbaikanAlatPage(), EMPTY_HINT, extractPhotoUrls(), MaintenanceEquipment, PerbaikanAlatClient(), rupiah() (+4 more)
...
### Community 17 - "buttonVariants"

Cohesion: 0.27
Nodes (8): Error(), InspeksiDashboardClient(), EquipmentItem, ReuseRequestItem, UnitKerjaDashboardContent(), NotFound(), Button(), buttonVariants
...
### Community 20 - "pemeliharaan/dashboard/page.tsx"

Cohesion: 0.19
Nodes (9): ManajerDashboardClient(), ManajerDashboardClientProps, Equipment, PemeliharaanDashboardPage(), relativeTime(), Repair, STAGE_OWNER, STATUS_COLOR (+1 more)

### Community 22 - "register-equipment-client.tsx"

Cohesion: 0.17
Nodes (7): EMPTY_FORM, MasterEquipmentCode, MasterOption, RegisterInitialData, AutocompleteInputProps, AutocompleteOption, YearPickerProps

### Community 23 - "getEquipments"

Cohesion: 0.06
Nodes (62): createDisposalRequest(), flattenEquipmentCode(), getApprovals(), getConditions(), getDisposalMethods(), getDisposals(), getEquipmentCodes(), getEquipmentRepairs() (+54 more)
...
Cohesion: 0.05
Nodes (65): apiUrl, nextConfig, absoluteFileUrl(), approveRevalidationEquipment(), createEquipment(), createReuseRequest(), createRevalidation(), deleteEquipment() (+57 more)
...
### Community 39 - "equipment-status.ts"
...
- **What connects `21st`, `npx`, `@ui-layouts/mcp` to the rest of the system?**
  *252 weakly-connected nodes found - possible documentation gaps or missing edges.*
- **Should `auth.ts` be split into smaller, more focused modules?**
  *Cohesion score 0.08579234972677596 - nodes in this community are weakly interconnected.*
...
- **Should `shared.tsx` be split into smaller, more focused modules?**
  *Cohesion score 0.12873563218390804 - nodes in this community are weakly interconnected.*
